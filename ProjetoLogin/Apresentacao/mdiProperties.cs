...
namespace ProjetoLogin.Apresentacao
{
    public static class mdiProperties
    {
        ...
        [DllImport("user32.dll")]
        private static extern int SetWindowLong(IntPtr hWnd, int nIndex, int dwNewLomg);

        [DllImport("user32.dll")]

        //manter o forms dentro da tela prinicipal, sem interferência de design vazando
